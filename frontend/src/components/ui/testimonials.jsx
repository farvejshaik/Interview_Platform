  ...
  const testimonials = [
    {
      ...
      content:
        "Talent Forge has completely transformed how I prepare for interviews. The real-time collaboration features are amazing!",
      avatar:
      ...
      <div className="page-container">
        <div className="section-header">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-base-content/70">
            ...
            technical interviews with Talent Forge
          </p>
        </div>
