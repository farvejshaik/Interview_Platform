    ...
    <div className="min-h-screen bg-linear-to-br from-base-100 via-base-200 to-base-300 text-base-content">
      ...
      <main>
        <HeroSection
          ...
          subtitle="The ultimate platform for collaborative coding interviews and pair programming. Connect face-to-face, code in real-time, and ace your technical interviews."
          actions={heroActions}
          stats={[
            {
              value: "10K+",
            ...
            },
            {
              value: "50K+",
              label: "Sessions",
              icon: <Code2Icon className="h-5 w-5 text-secondary" />,
            },
            {
              value: "99.9%",
              label: "Uptime",
